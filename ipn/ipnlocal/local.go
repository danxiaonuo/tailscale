...
func (b *LocalBackend) CheckUDPGROForwarding() error {
	...
	// communicating with the kernel via ethtool semantics/ioctl. These errors
	// are arguably more interesting for our future selves as we consider
	// tweaking netdev features automatically using similar API infra.
