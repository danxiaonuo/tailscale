...
// CheckUDPGROForwarding checks if the default route interface has a feature
// configuration that will net the highest throughput for forwarded UDP packets.
...
func CheckUDPGROForwarding(tunInterface, defaultRouteInterface string) (warn, err error) {
	...
	const kbLink = "\nSee https://tailscale.com/TODO" // DONOTMERGE(jwhited): update with real link
